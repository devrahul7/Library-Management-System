...
def open_signup_window():                   
    ...
    Password_label.place(x=210, y=390)
        ...
        if username and dob and contact and address and password:
            try:
                ...
                if role == "admin" and c.fetchone()[0] > 0:
                    messagebox.showerror("Error", "Admin is registered!*🤐*")
                    return

                c.execute("INSERT INTO users (username, dob, contact, address, password, role) VALUES (?, ?, ?, ?, ?, ?)", 
                          (username, dob, contact, address, password, role))
                conn.commit()
                messagebox.showinfo("Library Management System", "Sign up successfully *🤷‍♂️*")
                signup_window.destroy()
                open_login_window()
                
            except sqlite3.IntegrityError:
                messagebox.showerror("Error", "Username already exists*👾*")
                open_signup_window.destroy()
        else:
...
def open_login_window():
    ...
    def open_reset_password_window():
            ...
            if username and old_password and new_password and retype_password:
                if new_password == retype_password:
                    ...
                    if result:
                        ...
                        conn.commit()
                        messagebox.showinfo("Library Management System", "Password Reset Successfully!*🤷‍♂️*")
                        reset_window.destroy()  
                        login_window.deiconify()  #====================================== Redirect to the login window
                    else:
                        messagebox.showerror("Error", "Invalid username or old password*😉*")
                        reset_window.deiconify()
                    conn.close()
                else:
                    messagebox.showerror("Error", "New password and retyped password do not match!*😶‍🌫️*")
                    reset_window.deiconify()
            else:
        ...
        def exit_but():
            messagebox.showinfo("Library Management System", "You are all set to login again!🤷‍♂️")
            reset_window.destroy()  
            login_window.deiconify()# ==================================================Redirect to the login window
...
def open_add_member_window():
    ...
    Member_Name1= Label(add_member_window, text="Member Name:", bg="#8AAAE5", font=("Bold Arial", 20))
    Member_Name1.place(x=1000,y=110)
    Email1= Label(add_member_window, text="Email:", bg="#8AAAE5", font=("Bold Arial", 20))
    Email1.place(x=1000,y=180)
    Phone_Number1= Label(add_member_window, text="Phone Number:", bg="#8AAAE5", font=("Bold Arial", 20))
    Phone_Number1.place(x=1000,y=240)
    

    Label_Full_Name = Label(add_member_window, text="Full Name", bg="#8AAAE5", font=("Bold Arial", 20))
    ...
    Label_Username = Label(add_member_window, text="Username", bg="#8AAAE5", font=("Bold Arial", 20))
    Label_Username.place(x=200, y=180)
    Entry_Label_Username = Entry(add_member_window, width=15, font=('Arial', 24))
    Entry_Label_Username.place(x=350, y=180)

    Label_Email  = Label(add_member_window, text="Email", bg="#8AAAE5", font=("Bold Arial", 20))
    Label_Email .place(x=220, y=240)
    Entry_Label_Email = Entry(add_member_window, width=15, font=('Arial', 24))
    Entry_Label_Email.place(x=350, y=240)

    Label_Phone_number = Label(add_member_window, text="Phone No", bg="#8AAAE5", font=("Bold Arial", 20))
    Label_Phone_number.place(x=180, y=300)
    Entry_Label_Phone_number = Entry(add_member_window, width=15, font=('Arial', 24))
    Entry_Label_Phone_number.place(x=350, y=300)
    ...
    def add_member_to_db():
        ...
        messagebox.showinfo("Library Management System", "Member Added Successfully *🤷‍♂️*")
    ...
    def retrieve_member_to_db():
        ...
        if member:
            Member_Name1.config(text="Member Name: " + member[1])
            Email1.config(text="Email: " + member[2])
            Phone_Number1.config(text="Phone Number:" +member[3])
            messagebox.showinfo("Library Management System", "Member Retrieved Successfully *🤷‍♂️*")
            add_member_window.deiconify()
        else:
    ...
    Button_Retrieve_Book.place(x=360, y=600)

    Button_Delete_Book = Button(add_member_window, text="Delete Member", font=('Arial'), command=del_member)
    Button_Delete_Book.place(x=570, y=600)

    

    Button_Exit = Button(add_member_window, text="Exit", font=('Arial'), command=exit_1)
...
def open_book_list_window():
    ...
    Label(book_list_window, text="______", font=("Bold ", 20), bg="#8AAAE5").pack(padx=50,pady=40)
...
def add_book_window():
    ...
    Name_label.pack()
    Admin_book = Label(add_book_win, text="ADMIN ADD BOOK", font=("Arial Black", "20"), fg="black", bg='#8AAAE5', width=50)
    Admin_book.place(x=280, y=60)
    ...
    Book_Name1 = Label(add_book_win, text="Book Name:",bg="#8AAAE5", font=("Bold Arial", 20))
    Book_Name1.place(x=1000,y=110)
    Date_Published1 = Label(add_book_win, text="Date Published:",bg="#8AAAE5", font=("Bold Arial", 20))
    Date_Published1.place(x=1000,y=240)
    Author_Name1 = Label(add_book_win, text="Author:",bg="#8AAAE5", font=("Bold Arial", 20))
    Author_Name1.place(x=1000,y=180)




    Entry_Label_Full_Name = Label(add_book_win, text="Book Name", bg="#8AAAE5", font=("Bold Arial", 20))
    Entry_Label_Full_Name.place(x=200, y=110)
    Entry_Entry_Label_Full_Name = Entry(add_book_win, width=20, font=('Arial', 15))
    Entry_Entry_Label_Full_Name.place(x=400, y=110)

    Entry_Label_Username = Label(add_book_win, text="Book Number", bg="#8AAAE5", font=("Bold Arial", 20))
    Entry_Label_Username.place(x=200, y=180)
    book_number_entry = Entry(add_book_win, width=20, font=('Arial', 15))
    book_number_entry.place(x=400, y=180)

    Author_Label = Label(add_book_win, text="Author", bg="#8AAAE5", font=("Bold Arial", 20))
    Author_Label.place(x=200, y=240)
    Entry_Label_Email = Entry(add_book_win, width=20, font=('Arial', 15))
    Entry_Label_Email.place(x=400, y=240)

    Date_Published = Label(add_book_win, text="Date Published", bg="#8AAAE5", font=("Bold Arial", 20))
    Date_Published.place(x=200, y=300)
    Entry_Label_Phone_number = Entry(add_book_win, width=20, font=('Arial', 15))
    Entry_Label_Phone_number.place(x=400, y=300)
    ...
    def add_book_to_db():
        ...
        if not Entry_Label_Full_Name or not book_number or not author or not date_published:
            messagebox.showerror("Library Management System", "Please fill in all entry!*😉*")
        ...
        messagebox.showinfo("Library Management System", "Book successfully added!*🤷‍♂️*")
        add_book_win.destroy()
        open_admin_dashboard()
    ...
    def update_book_in_db():
        ...
        messagebox.showinfo("Library Management System", "Book Updated Successfully *🤷‍♂️*")
        add_book_win.deiconify()
    ...
    def retrieve_book_from_db():
        ...
        if book:
            Book_Name1.config(text="Book Name: " + book[1])
            Author_Name1.config(text="Author: " + book[2])
            Date_Published1.config(text="Date Published:" +book[3])

            messagebox.showinfo("Library Management System", "Book Retrieved Successfully *🤷‍♂️*")
            add_book_win.deiconify()
        else:
            messagebox.showerror("Library Management System", "Book Not Found *😉*")
            add_book_win.deiconify()
    ...
    Button_Exit = Button(add_book_win, text="Exit", font=('Arial'), command=exit_funct)
    Button_Exit.place(x=1150, y=600)
...
def open_payment_window():
    ...
    def payfunc():
        ...
        if due_date_str:
            ...
            if today > due_date:
                ...
                fine_amount = days_late * 0.569
                Amount_Entry.delete(0, END)
                Amount_Entry.insert(0, f"{fine_amount:.2f}")
                ...
                c.execute("INSERT INTO payment_history (book_name, book_number, fine_amount, cleared_date) VALUES (?, ?, ?, ?)",
                          (book_name, book_number, fine_amount, cleared_date))
                
                # ==========================================Add the book back to the admin's book list
                c.execute("INSERT INTO books (Entry_Label_Full_Name, book_number, author, date_published) VALUES (?, ?, ?, ?)", 
                          (book_name, book_number, "Unknown", "Unknown"))
                ...
                conn.commit()
                messagebox.showinfo("Library Management System", "Payment Successful and Book is returned to the library!")
            ...
            messagebox.showerror("Library Management System", "Book is not found in the borrowed books list!*😉*")
    ...
    def fine_treeview():
        ...
        conn = sqlite3.connect('Library_management_system.db')
        c = conn.cursor()
        c.execute("SELECT book_name, book_number, fine_amount, cleared_date FROM payment_history")
        ...
        if payment_history:
            total_label = Label(fine_details_window, text=f"Total Payments: {len(payment_history)}", font=("Arial", 16, "bold"), fg="blue", bg="#8AAAE5")
            total_label.place(x=280, y=500)
        else:
            no_history_label = Label(fine_details_window, text="No payment history found", font=("Arial", 16, "bold"), fg="red", bg="#8AAAE5")
            no_history_label.place(x=280, y=500)
...
def open_borrow_book_window():
    ...
    Entry_Book_Name = Entry(borrow_book_window, width=15, font=('Arial 20'))
    ...
    book_number_label.place(x=210, y=265)
    book_number_entry = Entry(borrow_book_window, width=15, font=('Arial 20'))
    book_number_entry.place(x=350, y=260)

    Date_Borrowed = Label(borrow_book_window, text="Due  Date", bg="#8AAAE5", font=("Bold Arial", "15"))
    Date_Borrowed.place(x=210, y=330)
    Due_Date_Entry = Entry(borrow_book_window, width=15, font=('Arial 20'))
    ...
    def borrow_book():
        ...
        if book_data:
            ...
            messagebox.showinfo("Library Management System", "Book is successfully borrowed *🤷‍♂️*")
            borrow_book_window.destroy()
            open_user_dashboard()
        else:
            messagebox.showerror("Library Management System", "Book is not found in the library *😉*")
            borrow_book_window.deiconify()
...
def open_user_dashboard():
    ...
    exit_but = Button(user_dashboard_window, text="  Log out ", bg="white", fg="red", font="50", width=8, command=log_out)
    exit_but.place(x=1050, y=450)
    book_view = Button(user_dashboard_window, text="View book", bg="white", fg="red", font="50", width=8, command=open_book_list_window)
    book_view.place(x=200, y=450)

# =============================================Add buttom frame for contact information
    frame1 = Frame(user_dashboard_window, bg="#7fa5e8", height=220, width=1600)
    frame1.place(x=0, y=520)  # Adjusted y-coordinate to place it at the bottom
    
    Enquiry_ = Label(frame1, text="Enquiries:", font=("Arial", 15), bg="#7fa5e8")
    Enquiry_.place(x=15, y=10)
    
    Email_id = Label(frame1, text="Email: bookwarica7@gmail.com", font=("Arial", 15), bg="#7fa5e8")
    Email_id.place(x=15, y=50)
